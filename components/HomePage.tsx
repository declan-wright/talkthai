...
export const HomePage: React.FC<HomePageProps> = ({ language, onSelectLesson, onStartConversationPractice, onStartWritingPractice, onStartReadingPractice, onBack, onRestartOnboarding, onChangeLanguage }) => {
        ...
        <div className="w-full max-w-6xl mx-auto py-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <aside className="md:col-start-3 md:row-start-1">
                    <Leaderboard entries={leaderboard} weeklyWinner={weeklyWinner} currentUserId={user?.uid || null} currentUserProfile={userProfile} language={language} onSelectUser={(uid) => setSelectedUid(uid)} />
